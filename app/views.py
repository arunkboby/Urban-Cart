import stripe
from.models import Register,Product, Cart, OrderItem,Order,Feedback, ProductReview
...
def func9(request):
    ...
    if request.method == 'POST':
        ...
        print("SAVED CATEGORY =", product.category)
...
from .models import Register, Product, Order
